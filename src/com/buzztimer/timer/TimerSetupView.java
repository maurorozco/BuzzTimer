...
import com.buzztimer.timer.TimerView;
...
//        }
    ...
    protected void updateTime() {
        mEnteredTime.setTime(mInput[4], mInput[3], mInput[2],
                mInput[1], mInput[0], mInputPointer);
    }
...
//    }
    ...
    public void saveEntryStateIntoPrefs(SharedPreferences prefs, String key) {
    	StringBuilder str = new StringBuilder();
    	for (int i = 0; i < mInput.length; i++) {
    		str.append(mInput[i]).append(",");
    	}
...
//    }
    ...
    public void restoreEntryStateFromPrefs(SharedPreferences prefs, String key) {
    	String savedString = prefs.getString(key, "");
//    	String savedString = "0,0,1,0,0,";
    	if(savedString!=null && !savedString.equals("")){
    		StringTokenizer st = new StringTokenizer(savedString, ",");
    		for (int i = 0; i < mInputSize; i++) {
    			mInput[i] = Integer.parseInt(st.nextToken());
    			if (mInput[i] != 0) {
    				mInputPointer = i;
    			}
    		}
