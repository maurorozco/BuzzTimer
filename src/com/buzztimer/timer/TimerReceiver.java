...
import com.buzztimer.timer.TimerRingService;
import com.buzztimer.timer.Utils;
...
//                mngr.setExact(AlarmManager.ELAPSED_REALTIME_WAKEUP, nextTimesup, p);
            	setAlarmFromKitkat(mngr, AlarmManager.ELAPSED_REALTIME_WAKEUP, nextTimesup, p);
            } else {
...
//          alarmManager.setExact(AlarmManager.ELAPSED_REALTIME, nextBroadcastTime, pendingNextBroadcast);
        	setAlarmFromKitkat(alarmManager, AlarmManager.ELAPSED_REALTIME, nextBroadcastTime, pendingNextBroadcast);
        } else {
    ...
    @TargetApi(19)
    private void setAlarmFromKitkat(AlarmManager am, int type, long ms, PendingIntent pi){
        am.setExact(type, ms, pi);
    }
